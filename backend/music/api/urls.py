...
urlpatterns = [
    ...
    path('progression/progress/<int:user_id>/', views.get_progression_progress_mode),
    path('interval/progress/update/<int:user_id>/', views.update_interval_progress),
    path('progression/progress/update/<int:user_id>/', views.update_progression_progress),
