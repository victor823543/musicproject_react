    ...
    return (
        <div className='h-screen w-screen flex max-lg:justify-center max-lg:items-center'>
            ...
            <div className='h-full flex flex-col justify-center lg:mx-auto max-lg:bg-zinc-700/40 max-lg:shadow-2xl max-lg:h-fit max-lg:p-6 max-lg:rounded-md'>
                ...
                <label className='text-3xl text-center font-extralight text-zinc-50 lg:text-teal-950 text-shadow-lg shadow-teal-800'>Pick a key</label>
                <select className="bg-slate-800 text-white font-light text-2xl lg:text-3xl py-2 px-4 rounded-sm shadow-sm shadow-teal-500" onChange={props.onSelectKeyChange}>
                ...
                <label className='text-3xl text-center font-extralight text-zinc-50 lg:text-teal-950 text-shadow-lg shadow-teal-800'>Pick a length</label>
                <select className="bg-slate-800 text-white  font-light text-2xl lg:text-3xl py-2 px-4 rounded-sm shadow-sm shadow-teal-500" onChange={props.onSelectLengthChange}>
                ...
                <label className='text-3xl text-center font-extralight text-zinc-50 lg:text-teal-950 text-shadow-lg shadow-teal-800'>Pick quality</label>
                <select className="bg-slate-800 text-white font-light text-2xl lg:text-3xl py-2 px-4 rounded-sm shadow-sm shadow-teal-500" onChange={props.onSelectQualityChange}>
                    <option value="" disabled>Pick quality</option>
