  ...
  return (
        <div className='fixed top-0 left-0 w-full h-full flex items-center justify-center bg-zinc-800 bg-opacity-50 z-10 pt-20 pb-4 '>
            <div className='modal-et hideScrollbar'>
                <div className='mb-6'>
                    <h1 className='text-center text-5xl font-montserrat mb-3'>Custom Settings</h1>
                    <h3 className='text-center text-xl font-montserrat font-light'>Create your own custiomizable session</h3>
                </div>
                <div className='grid grid-cols-1 md:grid-cols-2'>
                    <div className='px-10 md:border-r-2 md:border-sky-600 dark:md:border-blue-900'>
                        <h1 className='text-center text-4xl font-montserrat mb-3'>Directions</h1>
                    ...
                    <div className='px-10 max-md:mt-8'>
                        <h1 className='text-center text-4xl font-montserrat mb-3'>Octave scope</h1>
                        <div className='flex justify-center gap-4 flex-wrap'>
                    ...
                    <div className='px-10 md:border-r-2 md:border-sky-600 dark:md:border-blue-900 mt-8'>
                        <h1 className='text-center text-4xl font-montserrat mb-3'>Session length</h1>
                        <div className='flex justify-center gap-4 flex-wrap'>
                    ...
                    <div className='px-10 mt-8'>
                        <h1 className='text-center text-4xl font-montserrat mb-3'>Difficulty progression</h1>
                        <div className='flex justify-center gap-4 flex-wrap'>
                ...
                <div className='flex flex-col items-center mt-8 max-w-[1100px] px-10'>
                    <h1 className='text-center text-4xl font-montserrat mb-3'>Include intervals</h1>
                    <div className='flex justify-center gap-4 flex-wrap'>
                        {intervals.map((interval, index) => 
                                <div onClick={() => handleIntervalClick(index + 1)} key={interval} className={`${clickedIntervals[index + 1] ? clickedColor : defaultColor} modal-btn` }>
                                    {interval}
                                </div>
                        )}
